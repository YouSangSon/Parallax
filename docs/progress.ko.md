...
| Phase B | MCP context pack v0 | `impact_trace_context_for_change`로 agent가 작업 전 compact context를 받는 첫 read-only tool 구현. evidence resource v0와 explain entity v0는 완료, report/graph pagination은 다음 slice |
