...
업데이트: 2026-05-12 (Contract topology surface v0)
...
17. ✅ topology summary, CLI human output, MCP cross-repo link top-level hint로 producer/consumer 방향을 compact surface에 노출한다. 다음은 full parser/LSP depth와 richer topology/package depth로 확장한다.
