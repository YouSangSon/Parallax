...
> *Updated 2026-05-11, UI Explorer v0, TS/JS/JVM/Spring/Python/Go/Rust spans, OpenAPI contract impact baseline, workspace catalog v0, cross-repo contract resolver v0, OpenAPI nested schema diff v0, and MCP workspace/contract resources v0 documented*
...
- [`decisions.ko.md`](decisions.ko.md) — **누적 ADR 로그 (D-001..D-032)**. 모든 굳어진 결정과 거부된 대안 + 관련 commit. 가장 먼저 읽으면 좋은 *single source of truth*.
