...
업데이트: 2026-05-12 (Protobuf/AsyncAPI consumer resolver v0)
...
**Phase 6B multi-language + Spring Boot adapter pack v0 + trusted evidence + OpenAPI contract baseline + workspace catalog v0 + cross-repo contract resolver v0 + GraphQL/Protobuf/AsyncAPI consumer resolver v0 + OpenAPI/Protobuf/GraphQL/AsyncAPI contract diff v0**와
...
13. ✅ OpenAPI JSON/YAML nested schema/body diff, Protobuf contract diff v0, GraphQL contract diff v0, AsyncAPI contract diff v0, GraphQL/Protobuf/AsyncAPI consumer resolver v0를 완료했고, full parser/LSP depth와 build-system resolver로 확장한다.
