...
| 5 | cross-repo contract impact | active next. workspace catalog와 contract baseline 위에서 OpenAPI/protobuf/GraphQL consumer risk로 넓힌다. |
