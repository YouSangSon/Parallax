...
| source span persistence | landed: report/MCP evidence가 line/col range를 노출하고 TS/JS import-backed relation과 JVM/Spring endpoint/declaration/config/test relation은 bounded span을 기록 |
