...
> 마지막 업데이트: 2026-05-10 (persistent FTS + retrieval bench v0 landed; next is resource pagination/supersession)
...
| active next | entity persistent FTS projection + sqlite-vec ANN search lane |
