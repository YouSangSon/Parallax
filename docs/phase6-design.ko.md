...
| 항목 | 테스트 수 (예상) |
|---|---|
| 6.1/6.7 foundation regression | 2026-05-04 branch 검증: 140 passing |
...
| **남은 예상** | **~25** (현재 branch 140 passing에서 추가 예정) |
...
- [x] 2026-05-04 branch verification: `npm test` 140 passing, `npm run check`, `npm run docs:lint`, `npm audit --audit-level=high`
