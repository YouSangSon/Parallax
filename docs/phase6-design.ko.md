...
**최종 결정(2026-05-03): C with 2 refinements.** §6의 "Decided" 블록 참고. 이 branch는 해당 형태를 구현했고 이후 `decisions.ko.md`는 D-029까지 승격된 결정을 보유한다.
...
- [x] **6.A.1** — `docs/decisions.ko.md`에 D-019..D-029 결정 로그 추가
...
- [x] ADR D-019..D-029 정식 승격 (`decisions.ko.md`)
