...
test('bench report summary renders current metrics without a baseline', () => {
  ...
  assert.match(markdown, /\| Contract-diff cases \| 5\/5 \| n\/a \|/);
  assert.match(markdown, /\| Contract-diff changes \| 5\/5 \| n\/a \|/);
...
test('bench report summary renders metric and count deltas against a baseline', () => {
  ...
  assert.match(markdown, /\| Contract-diff quality \| 1\.0000 \| \+0\.4000 \|/);
  assert.match(markdown, /\| Contract-diff cases \| 5\/5 \| \+2 \|/);
  assert.match(markdown, /\| Contract-diff changes \| 5\/5 \| \+2 \|/);
