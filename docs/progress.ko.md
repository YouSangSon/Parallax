...
업데이트: 2026-05-11 (agentmemory v0.9.6 refresh + MCP/security guardrails)
...
| Phase B | MCP retrieval depth + resource contract | context/search/explain/telemetry/doctor/session import v0/v1, search retrieval depth v0, search budget/diversification v0, persistent FTS + retrieval bench v0, JSON graph pagination, typed error envelope v0는 완료. 다음 slice는 explicit supersession과 entity persistent FTS/ANN lane |
...
| 날짜 | 명령 | 결과 |
|---|---|---|
| 2026-05-11 | `npm test` | **206개 테스트 통과** |
