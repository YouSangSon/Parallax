...
비범위: UI 본구현, full call graph, protobuf/GraphQL/AsyncAPI contract diff.
...
| breaking-change classifier | protobuf/GraphQL/AsyncAPI contract diff가 downstream risk를 생성 |
