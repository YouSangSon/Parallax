...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0, OpenAPI endpoint-surface contract diff v0, JSON/YAML nested schema/body diff v0, MCP workspace/contract resources v0는 준비됨. protobuf/GraphQL/AsyncAPI diff는 예정 |
...
13. ✅ OpenAPI JSON/YAML nested schema/body diff를 완료했고, protobuf/GraphQL/AsyncAPI breaking-change 분류로 확장한다.
