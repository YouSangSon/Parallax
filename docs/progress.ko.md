...
**Phase 6B multi-language + Spring Boot adapter pack v0 + trusted evidence + OpenAPI contract baseline + workspace catalog v0 + cross-repo contract resolver v0 + OpenAPI/Protobuf/GraphQL/AsyncAPI contract diff v0**와
...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0, OpenAPI endpoint-surface contract diff v0, JSON/YAML nested schema/body diff v0, Protobuf contract diff v0, GraphQL contract diff v0, AsyncAPI contract diff v0, MCP workspace/contract resources v0는 준비됨. GraphQL/protobuf/AsyncAPI consumer resolver는 예정 |
...
13. ✅ OpenAPI JSON/YAML nested schema/body diff, Protobuf contract diff v0, GraphQL contract diff v0, AsyncAPI contract diff v0를 완료했고, GraphQL/protobuf/AsyncAPI consumer resolver로 확장한다.
