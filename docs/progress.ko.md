...
업데이트: 2026-05-11 (workspace catalog v0)
...
**Phase 6B multi-language + Spring Boot adapter pack v0 + trusted evidence + OpenAPI contract baseline + workspace catalog v0**와
...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline과 workspace catalog v0는 준비, cross-repo provider/consumer resolver와 contract diff는 예정 |
...
11. cross-repo provider/consumer resolver와 OpenAPI/protobuf/GraphQL/AsyncAPI breaking-change 분류를 구현한다.
