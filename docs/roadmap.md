...
| A4 | npm/pnpm/yarn + Maven/Gradle/Cargo/Go workspace 어댑터 | v0 landed: `package.json`, `pom.xml`, `build.gradle(.kts)`, Gradle `libs.versions.toml` direct/nested accessor resolution, `go.mod`, `Cargo.toml`, `pyproject.toml` manifest-only package graph. 다음은 lockfile/transitive/semver/workspace depth. |
