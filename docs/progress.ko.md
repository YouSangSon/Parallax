...
| Phase 6B | source span persistence | `relation_evidence` line/col/range 저장과 analyzer evidence output은 구현됨. TS/JS parser-backed import span v0와 JVM/Spring lightweight span v0로 bench `spanCompleteness`는 0.8718까지 개선됐고, 다음은 Python/Go/Rust 또는 workspace/contract resolver depth |
...
9. parser-backed depth pass를 Python/Go/Rust까지 넓혀 relation span/confidence를 더 정밀화한다.
