...
| active next | GraphQL/protobuf/AsyncAPI consumer resolver — OpenAPI/Protobuf/GraphQL/AsyncAPI compatibility signature rules 위에서 persisted downstream links로 확장 |
...
- **왜 이 결정인지 알고 싶다** → [decisions.ko.md](decisions.ko.md) (D-001..D-035)
