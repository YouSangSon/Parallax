...
- [`decisions.ko.md`](decisions.ko.md) — **누적 ADR 로그 (D-001..D-044)**. 모든 굳어진 결정과 거부된 대안 + 관련 commit. 가장 먼저 읽으면 좋은 *single source of truth*.
