...
| **Impact Map** | changed root에서 affected target까지 primary flow, 방향 화살표, 실제 graph link를 첫 화면 우선순위로 보여주고 target 선택 시 primary flow, 관련 edge, 경로, evidence를 같은 target으로 강조 |
