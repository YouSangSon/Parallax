...
<img src="docs/assets/parallax-ui-demo.png" alt="Parallax Impact Workbench UI showing change set, impact paths, evidence, and coverage status" width="100%">
...
`parallax ui`는 최신 report를 기준으로 바로 작업 화면을 띄운다. landing page가 아니라 Change Set, Impact Paths, Evidence, Focused Graph, Coverage Gaps, Doctor Findings를 한 화면에서 본다.
...
| **Focused Graph** | report graph의 compact preview |
