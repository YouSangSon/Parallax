...
[English](glossary.md) · **한국어** · [中文](glossary.zh.md)
...
### adapter_run
한 indexing pass의 메타데이터 — adapter ID, version, confidence, known gap, error summary. coverage gap과 adapter별 분석 신뢰도를 추적.
