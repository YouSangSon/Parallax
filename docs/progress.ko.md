...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0는 준비됨. contract diff와 breaking-change classification은 예정 |
...
12. OpenAPI/protobuf/GraphQL/AsyncAPI contract diff와 breaking-change 분류를 구현한다.
