...
업데이트: 2026-05-12 (Build-system/package resolver v0)
...
**Phase 6B multi-language + Spring Boot adapter pack v0 + trusted evidence + OpenAPI contract baseline + workspace catalog v0 + cross-repo contract resolver v0 + GraphQL/Protobuf/AsyncAPI consumer resolver v0 + OpenAPI/Protobuf/GraphQL/AsyncAPI contract diff v0 + build-system/package resolver v0**와
...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0, GraphQL/Protobuf/AsyncAPI consumer resolver v0, OpenAPI endpoint-surface contract diff v0, JSON/YAML nested schema/body diff v0, Protobuf contract diff v0, GraphQL contract diff v0, AsyncAPI contract diff v0, MCP workspace/contract resources v0는 준비됨. generated-client/event topology와 full parser/LSP depth는 예정 |
...
14. ✅ `package.json`, `pom.xml`, `build.gradle(.kts)`, `go.mod`, `Cargo.toml`, `pyproject.toml` manifest-only build-system/package resolver v0를 완료했고, 다음은 full parser/LSP depth와 generated-client/event topology로 확장한다.
