...
- docs/ADR 정리: Phase 6 foundation부터 OpenAPI nested schema diff까지 decisions log D-032로 갱신
...
다음 제품 slice는 AsyncAPI breaking rules와 GraphQL consumer resolver로 넓히는 것이다.
