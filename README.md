...
- TS/JS import edge 추출과 parser-backed import, declaration, imported call-site, local identifier call, same-class `this.method()`, class field arrow method, same-file `new ClassName()` instance call evidence span 저장
