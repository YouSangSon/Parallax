...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0, OpenAPI endpoint-surface contract diff v0, JSON/YAML nested schema/body diff v0, Protobuf contract diff v0, MCP workspace/contract resources v0는 준비됨. GraphQL/AsyncAPI diff는 예정 |
...
13. ✅ OpenAPI JSON/YAML nested schema/body diff와 Protobuf contract diff v0를 완료했고, GraphQL/AsyncAPI breaking-change 분류로 확장한다.
