...
- Python virtualenv/package resolver, Go transitive module/build-list resolver, Cargo feature/target/lockfile resolver, package-manager lockfile/transitive resolver
