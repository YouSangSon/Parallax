...
| Phase 6/7 | workspace/cross-repo resolver | contract baseline, workspace catalog v0, OpenAPI provider/consumer resolver v0, OpenAPI endpoint-surface contract diff v0, MCP workspace/contract resources v0는 준비됨. schema/body-level diff는 예정 |
...
13. OpenAPI schema/body-level diff와 protobuf/GraphQL/AsyncAPI breaking-change 분류로 확장한다.
