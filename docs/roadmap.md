...
| UI Work Artifacts panel — v0 landed: selected report에서 work artifact impact를 별도 panel/resource link preview로 노출하고 compact metadata/freshness를 표시 |
