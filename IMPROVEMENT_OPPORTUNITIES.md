...
**Sequencing:** W3 monorepo package modeling → S5/S6 storage/shareability. Residual S1 dirty/non-git scan-cost work waits for a measured adapter-contract design.
