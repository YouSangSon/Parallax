...
업데이트: 2026-05-12 (Gradle version catalog resolver v0)
...
15. ✅ `package.json`, `pom.xml`, `build.gradle(.kts)`, Gradle `libs.versions.toml`, `go.mod`, `Cargo.toml`, `pyproject.toml` manifest-only build-system/package resolver v0를 완료했다.
