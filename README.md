...
누적 결정 로그: [decisions.ko.md (D-001..D-022)](docs/decisions.ko.md).
...
- [Phase 6B multi-language + Spring Boot 계획](docs/phase6b-ts-accuracy-plan.ko.md) — 현재 slice: adapter pack v0 routing, ImpactBench fixture, TS/JS parser-backed import span v0, 다음 depth pass: JVM/Spring/Python/Go/Rust spans와 workspace contract
- [Architecture decisions log (D-001..D-022)](docs/decisions.ko.md) — 누적 ADR 로그
...
5. parser-backed adapter depth pass와 source-span evidence 확대: TS/JS import spans landed, 다음은 JVM/Spring/Python/Go/Rust depth
