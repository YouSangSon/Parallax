...
업데이트: 2026-05-11 (OpenAPI nested schema diff v0)
...
**Phase 6B multi-language + Spring Boot adapter pack v0 + trusted evidence + OpenAPI contract baseline + workspace catalog v0 + cross-repo contract resolver v0 + OpenAPI nested schema diff v0**와
...
13. ✅ OpenAPI JSON/YAML nested schema/body diff, Protobuf contract diff v0, GraphQL contract diff v0를 완료했고, AsyncAPI breaking-change 분류와 GraphQL/protobuf consumer resolver로 확장한다.
