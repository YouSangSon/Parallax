...
- docs/ADR 정리: Phase 6 foundation부터 AsyncAPI contract diff까지 decisions log D-035로 갱신
...
다음 제품 slice는 GraphQL/protobuf/AsyncAPI consumer resolver로 넓히는 것이다.
