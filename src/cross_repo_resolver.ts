...
import { firstMatchingGraphqlOperationLine } from './cross_repo/graphql.js';
import { firstMatchingHttpEvidence } from './cross_repo/http.js';
import { firstMatchingProtobufRpcLine } from './cross_repo/protobuf.js';
import {
  isDocumentationPath,
  isGeneratedProtobufFilePath,
  isSourceFilePath,
  isSourceOrConfigFilePath
} from './cross_repo/shared.js';
import type { ConsumerEvidence, CrossRepoEventTopology } from './cross_repo/types.js';

export type { CrossRepoEventTopology } from './cross_repo/types.js';
...
function firstMatchingEvidence(content: string, filePath: string, endpoint: ProviderEndpoint): ConsumerEvidence | undefined {
  ...
  return firstMatchingHttpEvidence(content, filePath, endpoint.httpMethod, endpoint.routePath);
}
