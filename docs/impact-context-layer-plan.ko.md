...
| work artifact impact view | v0 landed: selected report의 policy/decision/PRD/proposal impact를 별도 panel과 entity resource URI로 표시. frontmatter/heading metadata와 stale/current/unknown freshness preview 포함, artifact evidence snippet은 bootstrap에서 생략 |
