...
| Phase 6B | source span persistence | `relation_evidence` line/col/range 저장과 analyzer evidence output은 구현됨. TS/JS parser-backed import span v0, JVM/Spring lightweight span v0, Python/Go/Rust lightweight span v0로 bench `spanCompleteness`는 0.9535까지 개선됐고, 다음은 workspace/contract resolver depth |
...
| 날짜 | 명령 | 결과 |
|---|---|---|
| 2026-05-11 | `npm test` | **242개 테스트 통과** |
| 2026-05-11 | `npm run check` | 통과 |
| 2026-05-11 | `npm run docs:lint` | 통과 |
| 2026-05-11 | `npm run bench` | **통과** — score 0.9977, expected relations 43/43, `spanCompleteness` 0.9535, unexpected relations 0, retrieval Recall@5/10 1.0 |
