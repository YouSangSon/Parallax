...
> 마지막 업데이트: 2026-05-11 (agentmemory v0.9.6 refresh + MCP/security guardrails; next is supersession/entity ANN)
...
Phase 4 code baseline은 `33c49f0`에서 **112 tests passing**, ADR D-001..D-018, MCP 12개, CLI 16개였다. 현재 작업 브랜치는 session import v0, agentmemory follow-up roadmap, graph pagination/typed errors, MCP/security guardrails를 포함하며, 2026-05-11 기준 **206 tests passing**이다.
