...
- [x] SCIP import: `parallax scip import --file <index.scip or index.scip.json>` augments the latest completed index with SCIP definition/reference edges from external indexers
