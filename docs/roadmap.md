...
> 마지막 업데이트: 2026-05-11 (UI Explorer v0 landed; next is parser-backed adapter depth / workspace contracts)
...
| active next | parser-backed adapter depth pass 또는 workspace diff tool — multi-repo 변경 + downstream consumer risk |
