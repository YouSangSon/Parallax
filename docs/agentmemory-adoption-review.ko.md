...
| 5 | contract diff impact | active next. workspace catalog, contract baseline, cross-repo links 위에서 OpenAPI/protobuf/GraphQL consumer risk로 넓힌다. |
