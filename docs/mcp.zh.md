...
| `parallax_repo_map` | 返回 read-only token-budgeted repo map/context card，包含 changed root、affected file、test/docs/config/work artifact、evidence ref、verification action、resource link、confidence、provenance、known gap 与 omitted count | 是 |
