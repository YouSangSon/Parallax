...
| `parallax_resolve_cross_repo_contracts` | ✅ | Preview cross-repo provider/consumer contract links from the synchronized workspace DB view without mutating `cross_repo_links` |
